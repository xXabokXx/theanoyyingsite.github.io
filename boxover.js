...
function defHdrStyle() {
	...
	dvHdr.style.border='1px solid #333333';
	dvHdr.style.padding='3px';
	dvHdr.style.fontSize='9px';
	dvHdr.style.color='#000000';
	dvHdr.style.background='#f0f0f0';
	dvHdr.style.filter='alpha(opacity=100)'; // IE
	dvHdr.style.opacity='1'; // FF
}

function defBdyStyle() {
	dvBdy.style.borderBottom='1px solid #333333';
	dvBdy.style.borderLeft='1px solid #333333';
	dvBdy.style.borderRight='1px solid #333333';
